(function () {
  ...
  if (typeof window.PingPongGameFour === "undefined") {
    ...
    var Game = PingPongGameFour.Game = function (canvas, defines) {
      this.canvas = canvas;
      this.context = canvas.getContext('2d');
      this.canvas.width = defines.game_width;
      this.canvas.height = defines.game_height;
      this.ball = new PingPongGameFour.GameBall(this.context, defines.color_ball, defines.url_ball, defines.v_init);
      this.field = new PingPongGameFour.GameField(this.context, defines.game_width, defines.game_height, defines.color_ground, defines.url_ground);

      this.player_left = new PingPongGameFour.GamePlayer(this.context, "left", defines.left_color, defines.v_paddle);
      this.player_right = new PingPongGameFour.GamePlayer(this.context, "right", defines.right_color, defines.v_paddle);
      this.player_left1 = new PingPongGameFour.GamePlayer(this.context, "left1", defines.left_color, defines.v_paddle);
      this.player_right1 = new PingPongGameFour.GamePlayer(this.context, "right1", defines.right_color, defines.v_paddle);

      this.left_collision = new PingPongGameFour.HandleCollision(this.player_left, this.ball, this.context);
      this.right_collision = new PingPongGameFour.HandleCollision(this.player_right, this.ball, this.context);
      this.left_collision1 = new PingPongGameFour.HandleCollision(this.player_left1, this.ball, this.context);
      this.right_collision1 = new PingPongGameFour.HandleCollision(this.player_right1, this.ball, this.context);
	  ...
	  this.player_right1Name = defines.player_name_right1;
	  this.player_left1Name = defines.player_name_left1;
      ...
      console.log('Events visibilitychange and locationchange configured');
    };
    ...
    Game.prototype.handle_visibility_change = function () {
      ...
      if (document.hidden) {
        ...
        console.log('Returned to game page');
    ...
    Game.prototype.handle_route_change = function () {
      ...
      if (window.location.pathname !== '/game-path') {
        console.log('Exited game page - SPA Routing');
          clearInterval(this.match_interval);
          this.match_interval = null;
    ...
    Game.prototype.render = function () {
      ...
      if (this.player_left && this.player_left1 && this.player_right && this.player_right1) {
     
        this.player_left.render();
        this.player_right.render();
        this.player_left1.render();
        this.player_right1.render();
  
        this.player_left.check_paddle_position();
        this.player_right.check_paddle_position();
        this.player_left1.check_paddle_position();
        this.player_right1.check_paddle_position();
      }

      if (this.left_collision && this.right_collision && this.left_collision1 && this.right_collision1) {
        this.left_collision.check_collision();
        this.right_collision.check_collision();
        this.left_collision1.check_collision();
        this.right_collision1.check_collision();
      ...
      if (this.player_left.player_points >= this.maxPoints) {
        this.match_active = false;
        this.show_winner_message(this.player_leftName +  " and " + this.player_rightName);
        this.match_winner = this.player_leftName
        clearInterval(this.match_interval);
        return this.match_winner;
      } else if (this.player_right.player_points >= this.maxPoints) {
        this.match_active = false;
        this.show_winner_message(this.player_left1Name + " and " + this.player_right1Name);
        this.match_winner = this.player_right1Name;
        clearInterval(this.match_interval);
        return this.match_winner;
      }
    };
    ...
    Game.prototype.cleanup = function() {
      ...
      if (this.player_left1) {
        this.player_left1.cleanup();
        this.player_left1 = null;
      }
      if (this.player_right1) {
        this.player_right1.cleanup();
        this.player_right1 = null;
      }
      if (this.left_collision1) {
        this.left_collision1.cleanup();
        this.left_collision1 = null;
      }
      if (this.right_collision1) {
        this.right_collision1.cleanup();
        this.right_collision1 = null;
      }
