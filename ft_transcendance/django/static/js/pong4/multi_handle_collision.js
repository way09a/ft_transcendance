(function () {
  ...
  var HandleCollision = window.PingPongGameFour.HandleCollision = function (GamePlayer, GameBall, context) {
  ...
  HandleCollision.prototype.check_collision = function() {
    if ((this.Gplayer.player_side == "left" || this.Gplayer.player_side == "left1" ) && this.hit_left()) {
      this.ball.change_ball_direction()
      this.ball.ball_hits += 1;
      this.ball.ball_newHit += 1;
    } else if ((this.Gplayer.player_side == "right" ||  this.Gplayer.player_side == "right1")  && this.hit_right()) {
      this.ball.change_ball_direction()
      this.ball.ball_hits += 1;
      this.ball.ball_newHit += 1;
    }
  ...
  HandleCollision.prototype.score = function () {
    if ((this.Gplayer.player_side == "right" || this.Gplayer.player_side == "rigth1") && this.ball.is_left()) {
    ...
    } else if ((this.Gplayer.player_side == "left" || this.Gplayer.player_side == "left1") && this.ball.is_right()) {
              this.Gplayer.player_points +=1;
              this.ball.reset_increment();
