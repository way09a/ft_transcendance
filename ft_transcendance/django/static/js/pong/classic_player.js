(function () {
  ...
  var GamePlayer = window.PingPongGame.GamePlayer = function (context, player_side, color_player, v_paddle) {
    this.context = context;
    var paddle_start_position = player_side == "left" ? [20, 215] : [780, 215];
    this.paddle = new PingPongGame.PlayerPaddle(this.context, paddle_start_position, color_player);
